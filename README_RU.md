...
### **Сосчитай котов!** :heavy_check_mark:
...
### **Углеродное датирование** :heavy_check_mark:
...
### **Команда мечты** :heavy_check_mark:
...
### **Какая пора года??** :heavy_check_mark:
...
### **Ханойская башня** :heavy_check_mark:
...
### **Рекурсивный вычислитель глубины** :heavy_check_mark:
...
---
### **Расширенный повторитель** :heavy_check_mark:
